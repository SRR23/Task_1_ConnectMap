...
const Map = () => {
  ...
  //             onLineClick={
  //               mapState.isSavedRoutesEditable ? handleLineClick : null
  //             }
  //             onWaypointDragEnd={
  //               mapState.isSavedRoutesEditable ? handleWaypointDragEnd : null
  //             }
  //             onWaypointClick={
  //               mapState.isSavedRoutesEditable ? handleWaypointClick : null
  //             }
  //             onStartMarkerDragEnd={
  //               mapState.isSavedRoutesEditable ? handleStartMarkerDragEnd : null
  //             }
  //             onEndMarkerDragEnd={
  //               mapState.isSavedRoutesEditable ? handleEndMarkerDragEnd : null
  //             }
  //             isSaved={true}
  //             isEditable={mapState.isSavedRoutesEditable}
